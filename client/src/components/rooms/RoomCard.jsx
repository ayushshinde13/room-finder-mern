...
import { MapPin, X, Bed, Maximize2, Sparkles, Loader2 } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <div className="p-5 flex-1 flex flex-col justify-between">
          ...
          <div className="pt-4 mt-4 border-t border-slate-200/50 dark:border-slate-800/50 flex items-center justify-between gap-4">
            <div>
            ...
            {!room.isBooked && user && user.role === 'RENTER' && (
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white rounded-xl text-xs font-bold transition-all shadow-md shadow-emerald-500/5 flex items-center gap-1.5 disabled:opacity-50"
              >
